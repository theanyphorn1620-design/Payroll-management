...
SECRET_KEY = 'django-insecure-v%49w719hadcbc3uze1fcifas!ds(sqy76+!er5^z4@j71g1i='
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for the Payroll Management System (employees, attendance, salary, payslips).',
    'VERSION': '1.0.0',
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DB_USER', 'macbook'),
