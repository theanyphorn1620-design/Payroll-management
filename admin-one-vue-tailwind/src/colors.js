...
export const getButtonColor = (color, isOutlined, hasHover, isActive = false) => {
  const colors = {
    ...
    bgHover: {
      ...
      info: 'hover:bg-teal-700 hover:border-teal-700 dark:hover:bg-teal-600 dark:hover:border-teal-600',
    },
    borders: {
      white: 'border-white',
    ...
    outlineHover: {
      ...
      info: 'hover:bg-teal-600 hover:text-white dark:hover:text-white dark:hover:border-teal-600',
    },
  }
